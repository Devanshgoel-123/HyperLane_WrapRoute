...
import {SystemContract, IZRC20} from "@zetachain/toolkit/contracts/TestSystemContract.sol";
...
contract Swap is UniversalContract {
    ...
    function swapAndWithdraw(
        ...
        gateway.withdraw( //Method to send the tokens to the recipient on the connected chain
            recipient,
            outputAmount,
            targetToken,
            RevertOptions({
